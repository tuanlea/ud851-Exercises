...
public class NotificationUtils {
    private static final int WATER_REMINDER_INTENT_ID = 3417;
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        notificationManager.notify(WATER_REMINDER_INTENT_ID, builder.build());
    }
    ...
    private static PendingIntent contentIntent(Context context) {
        ...
        return PendingIntent.getActivity(context, WATER_REMINDER_INTENT_ID, startMainActivityIntent, PendingIntent.FLAG_UPDATE_CURRENT);
