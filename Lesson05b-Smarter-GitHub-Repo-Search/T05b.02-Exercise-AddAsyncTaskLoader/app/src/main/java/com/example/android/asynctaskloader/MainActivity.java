...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    private void makeGithubSearchQuery() {
        ...
        if (githubQuery.isEmpty()) {
            mUrlDisplayTextView.setText("Query is empty");
            return;
        }
        ...
        // DO (23) If the Loader was null, initialize it. Else, restart it.
        if (loader == null) {
    ...
    private void showJsonDataView() {
        ...
        mErrorMessageDisplay.setVisibility(INVISIBLE);
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        ...
        return new AsyncTaskLoader<String>(this) {
            ...
            protected String onLoadInBackground() {
                ...
                String searchQueryUrlExtra = args.getString(SEARCH_QUERY_URL_EXTRA);

                // (11) If the URL is null or empty, return null
                if (searchQueryUrlExtra == null || TextUtils.isEmpty(searchQueryUrlExtra)) {
                    return null;
                }

                // (12) Copy the try / catch block from the AsyncTask's doInBackground method
                try {
                    URL searchUrl = new URL(searchQueryUrlExtra);
